...
const translations = {
  ...
  hero_tagline: { en: 'I build modern web applications and AI-powered systems that solve real problems — from social impact sites to computer vision for industry. Founder of SurLab Studio.', es: 'Construyo aplicaciones web modernas y sistemas impulsados por IA que resuelven problemas reales — desde sitios de impacto social hasta visión artificial para la industria. Fundador de SurLab Studio.' },
  hero_cta_projects: { en: 'View Projects', es: 'Ver Proyectos' },
  hero_cta_contact: { en: 'Contact Me', es: 'Contáctame' },
  ...
  about_surlab: { en: 'Learn about SurLab Studio →', es: 'Conoce SurLab Studio →' },
  ...
  about_h4_title: { en: 'SurLab Studio Founder', es: 'Fundador de SurLab Studio' },
  about_h4_desc: { en: 'Founded SurLab Studio to prove that Colombia south has world-class tech talent with global vision.', es: 'Fundé SurLab Studio para demostrar que el sur de Colombia tiene talento tech de clase mundial con visión global.' },
